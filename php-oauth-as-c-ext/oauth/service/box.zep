...
class Box extends OAuth\V2\Service
{
	/**
     * Class constructor.
     *
	...
	public function __construct(
        ...
        if  empty baseApiUri {
            let baseApiUri = new OAuth\Uri("https://api.box.com/2.0/");
        }
    ...
    {
        return new OAuth\Uri("https://www.box.com/api/oauth2/authorize");
    }
    ...
    {
        return new OAuth\Uri("https://www.box.com/api/oauth2/token");
    }
