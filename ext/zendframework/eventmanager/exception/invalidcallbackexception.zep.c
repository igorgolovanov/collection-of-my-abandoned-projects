...
ZEPHIR_INIT_CLASS(ZendFramework_EventManager_Exception_InvalidCallbackException) {
	...
	zend_class_implements(zendframework_eventmanager_exception_invalidcallbackexception_ce TSRMLS_CC, 1, zendframework_eventmanager_exception_exceptioninterface_ce);
	return SUCCESS;
