...
ZEPHIR_INIT_CLASS(ZendFramework_Db_Adapter_Exception_InvalidConnectionParametersException) {
	...
	zend_class_implements(zendframework_db_adapter_exception_invalidconnectionparametersexception_ce TSRMLS_CC, 1, zendframework_db_adapter_exception_exceptioninterface_ce);
	return SUCCESS;
