...
ZEPHIR_INIT_CLASS(ZendFramework_Http_Client_Adapter_Exception_TimeoutException) {
	...
	zend_class_implements(zendframework_http_client_adapter_exception_timeoutexception_ce TSRMLS_CC, 1, zendframework_http_client_adapter_exception_exceptioninterface_ce);
	return SUCCESS;
