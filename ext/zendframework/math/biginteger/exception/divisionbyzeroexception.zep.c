...
ZEPHIR_INIT_CLASS(ZendFramework_Math_BigInteger_Exception_DivisionByZeroException) {
	...
	zend_class_implements(zendframework_math_biginteger_exception_divisionbyzeroexception_ce TSRMLS_CC, 1, zendframework_math_biginteger_exception_exceptioninterface_ce);
	return SUCCESS;
