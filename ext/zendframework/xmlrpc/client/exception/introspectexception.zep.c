...
ZEPHIR_INIT_CLASS(ZendFramework_XmlRpc_Client_Exception_IntrospectException) {
	...
	zend_class_implements(zendframework_xmlrpc_client_exception_introspectexception_ce TSRMLS_CC, 1, zendframework_xmlrpc_client_exception_exceptioninterface_ce);
	return SUCCESS;
