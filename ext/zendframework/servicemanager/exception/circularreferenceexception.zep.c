...
ZEPHIR_INIT_CLASS(ZendFramework_ServiceManager_Exception_CircularReferenceException) {
	...
	zend_class_implements(zendframework_servicemanager_exception_circularreferenceexception_ce TSRMLS_CC, 1, zendframework_servicemanager_exception_exceptioninterface_ce);
	return SUCCESS;
