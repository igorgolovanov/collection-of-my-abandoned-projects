...
ZEPHIR_INIT_CLASS(ZendFramework_File_Transfer_Exception_PhpEnvironmentException) {
	...
	zend_class_implements(zendframework_file_transfer_exception_phpenvironmentexception_ce TSRMLS_CC, 1, zendframework_file_transfer_exception_exceptioninterface_ce);
	return SUCCESS;
