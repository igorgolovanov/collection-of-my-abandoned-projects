...
PHP_METHOD(ZendFramework_Stdlib_PriorityQueue, remove) {
	...
	zephir_is_iterable(_0, &_2, &_1, 0, 0, "zendframework/stdlib/priorityqueue.zep", 103);
	for (
	...
	if (found) {
		...
		if (!(zephir_is_true(_6))) {
			...
			zephir_is_iterable(_8, &_10, &_9, 0, 0, "zendframework/stdlib/priorityqueue.zep", 115);
			for (
			  ...
			  ; zephir_hash_move_forward_ex(_10, &_9)
				...
				zephir_array_fetch_string(&data, item, SL("data"), PH_NOISY, "zendframework/stdlib/priorityqueue.zep", 110 TSRMLS_CC);
				ZEPHIR_OBS_NVAR(priority);
				zephir_array_fetch_string(&priority, item, SL("priority"), PH_NOISY, "zendframework/stdlib/priorityqueue.zep", 111 TSRMLS_CC);
...
PHP_METHOD(ZendFramework_Stdlib_PriorityQueue, unserialize) {
	...
	zephir_check_call_status();
	zephir_is_iterable(unserialized, &_2, &_1, 0, 0, "zendframework/stdlib/priorityqueue.zep", 226);
	for (
	  ; zephir_hash_get_current_data_ex(_2, (void**) &_3, &_1) == SUCCESS
	  ; zephir_hash_move_forward_ex(_2, &_1)
	) {
		...
		zephir_array_fetch_string(&datum, item, SL("data"), PH_NOISY, "zendframework/stdlib/priorityqueue.zep", 221 TSRMLS_CC);
		ZEPHIR_OBS_NVAR(priority);
		zephir_array_fetch_string(&priority, item, SL("priority"), PH_NOISY, "zendframework/stdlib/priorityqueue.zep", 222 TSRMLS_CC);
...
PHP_METHOD(ZendFramework_Stdlib_PriorityQueue, toDataArray) {
	...
	zephir_array_fetch_string(&_0, item, SL("data"), PH_NOISY | PH_READONLY, "zendframework/stdlib/priorityqueue.zep", 267 TSRMLS_CC);
	RETURN_CTORW(_0);
...
PHP_METHOD(ZendFramework_Stdlib_PriorityQueue, toPriorityArray) {
	...
	zephir_array_fetch_string(&_0, item, SL("priority"), PH_NOISY | PH_READONLY, "zendframework/stdlib/priorityqueue.zep", 272 TSRMLS_CC);
	RETURN_CTORW(_0);
...
PHP_METHOD(ZendFramework_Stdlib_PriorityQueue, contains) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("items"), PH_NOISY_CC);
	zephir_is_iterable(_0, &_2, &_1, 0, 0, "zendframework/stdlib/priorityqueue.zep", 305);
	for (
	  ; zephir_hash_get_current_data_ex(_2, (void**) &_3, &_1) == SUCCESS
	  ; zephir_hash_move_forward_ex(_2, &_1)
	) {
		ZEPHIR_GET_HVALUE(item, _3);
		zephir_array_fetch_string(&_4, item, SL("data"), PH_NOISY | PH_READONLY, "zendframework/stdlib/priorityqueue.zep", 301 TSRMLS_CC);
		if (ZEPHIR_IS_IDENTICAL(_4, datum)) {
			RETURN_MM_BOOL(1);
		}
	}
...
PHP_METHOD(ZendFramework_Stdlib_PriorityQueue, hasPriority) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("items"), PH_NOISY_CC);
	zephir_is_iterable(_0, &_2, &_1, 0, 0, "zendframework/stdlib/priorityqueue.zep", 323);
	for (
	  ; zephir_hash_get_current_data_ex(_2, (void**) &_3, &_1) == SUCCESS
	  ; zephir_hash_move_forward_ex(_2, &_1)
	) {
		ZEPHIR_GET_HVALUE(item, _3);
		zephir_array_fetch_string(&_4, item, SL("priority"), PH_NOISY | PH_READONLY, "zendframework/stdlib/priorityqueue.zep", 319 TSRMLS_CC);
