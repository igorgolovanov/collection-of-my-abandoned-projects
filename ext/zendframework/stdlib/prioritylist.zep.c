...
PHP_METHOD(ZendFramework_Stdlib_PriorityList, setPriority) {
	...
	if (unlikely(!zephir_array_isset(_0, name))) {
		...
		zephir_throw_exception_debug(_1, "zendframework/stdlib/prioritylist.zep", 85 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_NVAR(_1);
...
PHP_METHOD(ZendFramework_Stdlib_PriorityList, get) {
	...
	zval *name_param = NULL, *item, *data, *_0;
	zval *name = NULL;
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("items"), PH_NOISY_CC);
	if (zephir_array_isset_fetch(&item, _0, name, 1 TSRMLS_CC)) {
...
PHP_METHOD(ZendFramework_Stdlib_PriorityList, compare) {
	...
	zephir_array_fetch_string(&_0, item1, SL("priority"), PH_NOISY | PH_READONLY, "zendframework/stdlib/prioritylist.zep", 168 TSRMLS_CC);
	zephir_array_fetch_string(&_1, item2, SL("priority"), PH_NOISY | PH_READONLY, "zendframework/stdlib/prioritylist.zep", 168 TSRMLS_CC);
	if (ZEPHIR_IS_IDENTICAL(_0, _1)) {
		zephir_array_fetch_string(&_2, item1, SL("serial"), PH_NOISY | PH_READONLY, "zendframework/stdlib/prioritylist.zep", 169 TSRMLS_CC);
		zephir_array_fetch_string(&_3, item2, SL("serial"), PH_NOISY | PH_READONLY, "zendframework/stdlib/prioritylist.zep", 169 TSRMLS_CC);
		if (ZEPHIR_GT(_2, _3)) {
			result = -1;
		} else {
			result = 1;
		...
		zephir_array_fetch_string(&_2, item1, SL("priority"), PH_NOISY | PH_READONLY, "zendframework/stdlib/prioritylist.zep", 176 TSRMLS_CC);
		zephir_array_fetch_string(&_3, item2, SL("priority"), PH_NOISY | PH_READONLY, "zendframework/stdlib/prioritylist.zep", 176 TSRMLS_CC);
		if (ZEPHIR_GT(_2, _3)) {
			result = -1;
		} else {
			result = 1;
...
PHP_METHOD(ZendFramework_Stdlib_PriorityList, current) {
	...
	if (!ZEPHIR_IS_FALSE_IDENTICAL(node)) {
		zephir_array_fetch_string(&_2, node, SL("data"), PH_NOISY | PH_READONLY, "zendframework/stdlib/prioritylist.zep", 230 TSRMLS_CC);
		RETURN_CTOR(_2);
	}
	RETURN_MM_BOOL(0);
...
PHP_METHOD(ZendFramework_Stdlib_PriorityList, next) {
	...
	zephir_check_call_status();
	if (!ZEPHIR_IS_FALSE_IDENTICAL(node)) {
		zephir_array_fetch_string(&_2, node, SL("data"), PH_NOISY | PH_READONLY, "zendframework/stdlib/prioritylist.zep", 258 TSRMLS_CC);
		RETURN_CTOR(_2);
	}
	RETURN_MM_BOOL(0);
