...
PHP_METHOD(ZendFramework_Loader_PluginClassLoader, __construct) {
	...
	ZEPHIR_INIT_VAR(_1);
	array_init_size(_1, 69);
	add_assoc_stringl_ex(_1, SS("accept"), SL("Zend\\Http\\Header\\Accept"), 1);
	add_assoc_stringl_ex(_1, SS("acceptcharset"), SL("Zend\\Http\\Header\\AcceptCharset"), 1);
	add_assoc_stringl_ex(_1, SS("acceptencoding"), SL("Zend\\Http\\Header\\AcceptEncoding"), 1);
	add_assoc_stringl_ex(_1, SS("acceptlanguage"), SL("Zend\\Http\\Header\\AcceptLanguage"), 1);
	add_assoc_stringl_ex(_1, SS("acceptranges"), SL("Zend\\Http\\Header\\AcceptRanges"), 1);
	add_assoc_stringl_ex(_1, SS("age"), SL("Zend\\Http\\Header\\Age"), 1);
	add_assoc_stringl_ex(_1, SS("allow"), SL("Zend\\Http\\Header\\Allow"), 1);
	add_assoc_stringl_ex(_1, SS("authenticationinfo"), SL("Zend\\Http\\Header\\AuthenticationInfo"), 1);
	add_assoc_stringl_ex(_1, SS("authorization"), SL("Zend\\Http\\Header\\Authorization"), 1);
	add_assoc_stringl_ex(_1, SS("cachecontrol"), SL("Zend\\Http\\Header\\CacheControl"), 1);
	add_assoc_stringl_ex(_1, SS("connection"), SL("Zend\\Http\\Header\\Connection"), 1);
	add_assoc_stringl_ex(_1, SS("contentdisposition"), SL("Zend\\Http\\Header\\ContentDisposition"), 1);
	add_assoc_stringl_ex(_1, SS("contentencoding"), SL("Zend\\Http\\Header\\ContentEncoding"), 1);
	add_assoc_stringl_ex(_1, SS("contentlanguage"), SL("Zend\\Http\\Header\\ContentLanguage"), 1);
	add_assoc_stringl_ex(_1, SS("contentlength"), SL("Zend\\Http\\Header\\ContentLength"), 1);
	add_assoc_stringl_ex(_1, SS("contentlocation"), SL("Zend\\Http\\Header\\ContentLocation"), 1);
	add_assoc_stringl_ex(_1, SS("contentmd5"), SL("Zend\\Http\\Header\\ContentMD5"), 1);
	add_assoc_stringl_ex(_1, SS("contentrange"), SL("Zend\\Http\\Header\\ContentRange"), 1);
	add_assoc_stringl_ex(_1, SS("contenttransferencoding"), SL("Zend\\Http\\Header\\ContentTransferEncoding"), 1);
	add_assoc_stringl_ex(_1, SS("contenttype"), SL("Zend\\Http\\Header\\ContentType"), 1);
	add_assoc_stringl_ex(_1, SS("cookie"), SL("Zend\\Http\\Header\\Cookie"), 1);
	add_assoc_stringl_ex(_1, SS("date"), SL("Zend\\Http\\Header\\Date"), 1);
	add_assoc_stringl_ex(_1, SS("etag"), SL("Zend\\Http\\Header\\Etag"), 1);
	add_assoc_stringl_ex(_1, SS("expect"), SL("Zend\\Http\\Header\\Expect"), 1);
	add_assoc_stringl_ex(_1, SS("expires"), SL("Zend\\Http\\Header\\Expires"), 1);
	add_assoc_stringl_ex(_1, SS("from"), SL("Zend\\Http\\Header\\From"), 1);
	add_assoc_stringl_ex(_1, SS("host"), SL("Zend\\Http\\Header\\Host"), 1);
	add_assoc_stringl_ex(_1, SS("ifmatch"), SL("Zend\\Http\\Header\\IfMatch"), 1);
	add_assoc_stringl_ex(_1, SS("ifmodifiedsince"), SL("Zend\\Http\\Header\\IfModifiedSince"), 1);
	add_assoc_stringl_ex(_1, SS("ifnonematch"), SL("Zend\\Http\\Header\\IfNoneMatch"), 1);
	add_assoc_stringl_ex(_1, SS("ifrange"), SL("Zend\\Http\\Header\\IfRange"), 1);
	add_assoc_stringl_ex(_1, SS("ifunmodifiedsince"), SL("Zend\\Http\\Header\\IfUnmodifiedSince"), 1);
	add_assoc_stringl_ex(_1, SS("keepalive"), SL("Zend\\Http\\Header\\KeepAlive"), 1);
	add_assoc_stringl_ex(_1, SS("lastmodified"), SL("Zend\\Http\\Header\\LastModified"), 1);
	add_assoc_stringl_ex(_1, SS("location"), SL("Zend\\Http\\Header\\Location"), 1);
	add_assoc_stringl_ex(_1, SS("maxforwards"), SL("Zend\\Http\\Header\\MaxForwards"), 1);
	add_assoc_stringl_ex(_1, SS("origin"), SL("Zend\\Http\\Header\\Origin"), 1);
	add_assoc_stringl_ex(_1, SS("pragma"), SL("Zend\\Http\\Header\\Pragma"), 1);
	add_assoc_stringl_ex(_1, SS("proxyauthenticate"), SL("Zend\\Http\\Header\\ProxyAuthenticate"), 1);
	add_assoc_stringl_ex(_1, SS("proxyauthorization"), SL("Zend\\Http\\Header\\ProxyAuthorization"), 1);
	add_assoc_stringl_ex(_1, SS("range"), SL("Zend\\Http\\Header\\Range"), 1);
	add_assoc_stringl_ex(_1, SS("referer"), SL("Zend\\Http\\Header\\Referer"), 1);
	add_assoc_stringl_ex(_1, SS("refresh"), SL("Zend\\Http\\Header\\Refresh"), 1);
	add_assoc_stringl_ex(_1, SS("retryafter"), SL("Zend\\Http\\Header\\RetryAfter"), 1);
	add_assoc_stringl_ex(_1, SS("server"), SL("Zend\\Http\\Header\\Server"), 1);
	add_assoc_stringl_ex(_1, SS("setcookie"), SL("Zend\\Http\\Header\\SetCookie"), 1);
	add_assoc_stringl_ex(_1, SS("te"), SL("Zend\\Http\\Header\\TE"), 1);
	add_assoc_stringl_ex(_1, SS("trailer"), SL("Zend\\Http\\Header\\Trailer"), 1);
	add_assoc_stringl_ex(_1, SS("transferencoding"), SL("Zend\\Http\\Header\\TransferEncoding"), 1);
	add_assoc_stringl_ex(_1, SS("upgrade"), SL("Zend\\Http\\Header\\Upgrade"), 1);
	add_assoc_stringl_ex(_1, SS("useragent"), SL("Zend\\Http\\Header\\UserAgent"), 1);
	add_assoc_stringl_ex(_1, SS("vary"), SL("Zend\\Http\\Header\\Vary"), 1);
	add_assoc_stringl_ex(_1, SS("via"), SL("Zend\\Http\\Header\\Via"), 1);
	add_assoc_stringl_ex(_1, SS("warning"), SL("Zend\\Http\\Header\\Warning"), 1);
	add_assoc_stringl_ex(_1, SS("wwwauthenticate"), SL("Zend\\Http\\Header\\WWWAuthenticate"), 1);
	zephir_update_property_this(this_ptr, SL("plugins"), _1 TSRMLS_CC);
