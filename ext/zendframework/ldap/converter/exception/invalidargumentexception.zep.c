...
ZEPHIR_INIT_CLASS(ZendFramework_Ldap_Converter_Exception_InvalidArgumentException) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Zend\\Ldap\\Converter\\Exception, InvalidArgumentException, zendframework, ldap_converter_exception_invalidargumentexception, spl_ce_InvalidArgumentException, NULL, 0);
