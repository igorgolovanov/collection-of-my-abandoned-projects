...
class GeneratorInstance
{
     ...
     * @param array       $params
     */
    public function __construct(string $class, string alias, constructor, array! params)
    {
        let this->$class = $class;
        let this->alias = alias;
        let this->constructor = constructor;
     ...
     * @return GeneratorInstance
     */
    public function addMethod(method) -> <GeneratorInstance>
    {
