...
class ValidatorPluginManager extends \Zend\ServiceManager\AbstractPluginManager implements \Zend\ServiceManager\ServiceLocatorAwareInterface, \Zend\ServiceManager\ServiceLocatorInterface
{
     ...
     * @return void
     */
    public function injectValidatorPluginManager(validator) -> void
    {
