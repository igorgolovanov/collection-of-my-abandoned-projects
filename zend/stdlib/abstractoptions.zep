...
abstract class AbstractOptions implements ParameterObjectInterface
{
    ...
    public function toArray() -> array
    {
        ...
        for value, key in this {
            ...
            let normalizedKey = preg_replace_callback("/([A-Z])/", callback, key);
            let data[normalizedKey] = value;
        }
        return data;
    }

    private function transformArray(array! letters)
    {
        string letter;
        let letter = array_shift(letters);
