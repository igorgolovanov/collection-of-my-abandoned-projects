...
abstract class ArrayUtils
{
     ...
     * @return bool
     */
    public static function hasStringKeys(var value, boolean allowEmpty = false) -> boolean
    {
        var keys, filtered;
     ...
     * @return bool
     */
    public static function hasIntegerKeys(var value, boolean allowEmpty = false) -> boolean
    {
        var keys, filtered;
     ...
     * @return bool
     */
    public static function hasNumericKeys(var value, boolean allowEmpty = false) -> boolean
    {
        var keys, filtered;
     ...
     * @return bool
     */
    public static function isList(var value, boolean allowEmpty = false) -> boolean
    {
        var values;
     ...
     * @return bool
     */
    public static function isHashTable(var value, boolean allowEmpty = false) -> boolean
    {
        var values;
     ...
     * @return bool
     */
    public static function inArray(var needle, array! haystack, var strict = false) -> boolean
    {
        string type;
        var h, i;
        ...
        for key, value in b {
            if isset a[key] {
                if typeof value == "integer" && !preserveNumericKeys {
                    array_push(a, value); // todo:change
                    continue;
                } 
                if typeof value == "array" {
                    let av = a[key];
