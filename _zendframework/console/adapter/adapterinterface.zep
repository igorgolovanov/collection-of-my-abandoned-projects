...
interface AdapterInterface
{
     ...
     * @return void
     */
    public function write(string text, int color = null, int bgColor = null) -> void;
     ...
     * @return void
     */
    public function writeText(string text, int color = null, int bgColor = null) -> void;
     ...
     * @return void
     */
    public function writeLine(string text = "", int color = null, int bgColor = null) -> void;
     ...
     * @return void
     */
    public function writeAt(string text, int x, int y, int color = null, int bgColor = null) -> void;
     ...
     * @return void
     */
    public function writeBox(int x1, int y1, int x2, int y2, int lineStyle = self::LINE_SINGLE, int fillStyle = self::FILL_NONE, int color = null, int bgColor = null, int fillColor = null, int fillBgColor = null) -> void;
     ...
     * @return void
     */
    public function writeTextBlock(string text, int width, int height = null, int x = 0, int y = 0, int color = null, int bgColor = null) -> void;
     ...
     * @return string
     */
    public function colorize(string $string, int color = null, int bgColor = null) -> string;
     ...
     * @return void
     */
    public function setBgColor(int color) -> void;
     ...
     * @return string
     */
    public function readLine(int maxLength = 2048) -> string;
     ...
     * @return string
     */
    public function readChar(string mask = null) -> string;
